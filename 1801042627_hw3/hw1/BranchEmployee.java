...
public class BranchEmployee extends Person{
    ...
    public Product removeProduct(int indexOfProduct)throws BranchEmployeeDoesNotHaveAuthority,IndexOutOfBoundsException{
        ...
        if(branch.getProducts().size()<indexOfProduct){
            throw new IndexOutOfBoundsException();
        }
        Product pro = branch.getProducts().get(indexOfProduct);
        branch.getProducts().remove(indexOfProduct);
        return pro;
    }
    /**
     ...
     */
    public HybridList<Product> getPreviousOrders(Company company,int customerNumber){
