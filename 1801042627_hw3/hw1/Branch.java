...
public class Branch {
    ...
    private MArrayList<BranchEmployee> branchEmployees;
    ...
    public Branch(Company company){
        ...
        branchEmployees = new MArrayList<BranchEmployee>();
   ...
   public int getIndex(){
      return company.getBranches().indexOf(this);
   }
    /**
     ...
     public static vector<BranchEmployee> createEmployees(int numberOfEmployees,int indexOfBranch){ 
        ...
        vector<BranchEmployee> emps = new vector<BranchEmployee>();
         for(int j = 0;j < numberOfEmployees ; j++){ 
            emps.add(new BranchEmployee("EmployeeName"+Integer.toString(indexOfBranch+1)+" "+Integer.toString(j+1),"EmployeeSurname"+Integer.toString(indexOfBranch+1)+" "+Integer.toString(j+1)));
         }
        // emps.show();
         return emps;
     }
     */
      ...
      * @return employees at the branch
      */
     public MArrayList<BranchEmployee> getEmployees(){
